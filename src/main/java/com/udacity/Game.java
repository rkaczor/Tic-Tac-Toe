...
public class Game {
    ...
    public String checkGameWinner(char[][] grid) {
        ...
        //poziomo
        for (int j = 0; j<3; j++){
            if (grid[0][j] == grid[1][j] && grid[1][j] == grid[2][j] && (grid[2][j] == 'o' || grid[2][j] == 'x')){
                char cname = grid[2][j];
                String name = String.valueOf(cname);
                result = name + " wins";
                return result;
        ...
        //skos od lewej
        if (grid[0][0] == grid[1][1] && grid[1][1] == grid[2][2] && (grid[2][2] == 'o' || grid[2][2] == 'x')){
            char cname = grid[2][2];
            String name = String.valueOf(cname);
            result = name + " wins";
            return result;
        ...
        //skos od prawej
        if (grid[0][2] == grid[1][1] && grid[1][1] == grid[2][0] && (grid[2][0] == 'o' || grid[2][0] == 'x')){
            char cname = grid[2][0];
            String name = String.valueOf(cname);
            result = name + " wins";
            return result;
